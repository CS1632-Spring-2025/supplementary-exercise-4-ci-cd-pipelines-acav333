...
public class CatUnitTest {
	...
	public void testGetId() {
		// TODO: Fill in
		int id = c.getId();
		assertEquals("The cat ID should be 1", 1, id);
	}
	...
	public void testGetName() {
		...
		assertEquals("The cat name should be Jennyanydots", "Jennyanydots", name);
	}
	...
	public void testGetRented() {
		...
		assertEquals("The rented value should be false", false, rented);
	}
	...
	public void testToString() {
		...
		assertEquals("The toString should be 'ID 1. Jennyanydots'", "ID 1. Jennyanydots", toString);
	}
	...
	public void testRentCat() {
		...
		c.rentCat();
		boolean rented = c.getRented();
		assertEquals("The rented value should be true", true, rented);
	...
	public void testRenameCat() {
		...
		assertEquals("The cat name should be Garfield", "Garfield", name);
		assertEquals("The toString should be 'ID 1. Garfield'", "ID 1. Garfield", toString);
	}
